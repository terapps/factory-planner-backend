...
@Component
class ManufacturerVariablePowerIsRepresentedBy : SatisfactoryRelationshipTransformer<FGBuildableManufacturerVariablePower, Collection<Relationship>>(
    ...
    override fun transform(transformIn: FGBuildableManufacturerVariablePower): Collection<Relationship> {
