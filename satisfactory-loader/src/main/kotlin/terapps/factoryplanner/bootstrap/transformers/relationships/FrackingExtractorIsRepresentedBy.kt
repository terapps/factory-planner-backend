...
@Component
class FrackingExtractorIsRepresentedBy : SatisfactoryRelationshipTransformer<FGBuildableFrackingExtractor, Collection<Relationship>>(
    ...
    override fun transform(transformIn: FGBuildableFrackingExtractor): Collection<Relationship> {
