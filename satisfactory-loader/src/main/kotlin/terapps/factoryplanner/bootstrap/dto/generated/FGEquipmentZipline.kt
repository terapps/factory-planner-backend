...
val mMaxZiplineAngle: Float,
val mOnlyVisibleToOwner: String,
val mReceivedDamageModifiers: String,
val mShouldPlayDeactivateSound: String,
val mTraceDistance: Float,
val mTraceRadius: Float,
val mTraceStartOffset: Float,
val mUseDefaultPrimaryFire: String,
val mVisualizeTraceDistance: String,
val mZiplineJumpLaunchVelocity: Float,
val mZiplineReattachCooldown: Float
): GameEntity()
