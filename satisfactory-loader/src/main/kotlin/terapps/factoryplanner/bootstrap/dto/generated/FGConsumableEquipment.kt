...
data class FGConsumableEquipment(
        ...
        val `mEatMontage`: String? = null,
        val `mRandomAnim`: Int? = null,
        val `mReEquipAfterEatMontage`: String? = null,
        val `mCurrentMedkitUseMontage`: String? = null,
        val `mMedkitUseMontages`: String? = null
) : GameEntity()
